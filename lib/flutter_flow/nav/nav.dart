...
class AppStateNotifier extends ChangeNotifier {
  StateFarmCarouselFirebaseUser? initialUser;
  StateFarmCarouselFirebaseUser? user;
  ...
  void update(StateFarmCarouselFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'insuranceList',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'InsuranceList')
                  : InsuranceListWidget(),
            ),
            FFRoute(
              name: 'Home',
